...
export default function InstructorDashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const instructorId = currentUser.id || currentUser.userId || currentUser.sub;

      if (!instructorId) {
        console.error("No instructor ID found in user data");
        // Don't fetch if no ID, just stop loading
        setLoading(false);
        return;
      }
