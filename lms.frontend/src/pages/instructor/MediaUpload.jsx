...
export default function MediaUpload() {
  ...
  const handleUpload = async () => {
    ...
    if (!selectedLessonId) {
      toast.error("Please select a lesson to attach the media");
      return;
    }
    ...
    try {
      // Use mediaService instead of direct fetch
      // Note: axios upload progress implementation would require additional config in service
      // For now we simulate progress or just show processing state

      const result = await mediaService.uploadMedia(selectedFile, id, selectedLessonId);

      toast.success("File uploaded successfully and attached to lesson!");
