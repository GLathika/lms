...
public class AdminServiceImpl implements AdminService {
    ...
    public Map<String, Object> getAdminStats() {
        ...
        stats.put("pendingApprovals", pendingCourses); // Key matching frontend
    ...
    public List<Map<String, Object>> getRecentActivity() {
            ...
            if (!recentCourses.isEmpty()) {
                return recentCourses.stream().map(course -> {
                    ...
                    activity.put("message",
                            course.isApproved() ? "Course \"" + course.getTitle() + "\" was approved"
        ...
        return List.of(
                Map.of("action", "User registered", "description", "New student joined", "timestamp", new Date(),
                        "icon", "👤"),
                Map.of("action", "Course created", "description", "New course added by instructor", "timestamp",
                        new Date(), "icon", "📚"),
                Map.of("action", "User role updated", "description", "Admin updated user permissions", "timestamp",
                        new Date(), "icon", "⚙️"));
    }
