...
public class DataSeeder implements CommandLineRunner {
        ...
        private void createJavaFullStackCourse(User instructor, Category category) {
                ...
                List<Lesson> lessons = Arrays.asList(
                                createLesson("Introduction to Full Stack",
                                                ...
                                                1800, 1, savedCourse),
                                createLesson("Java Fundamentals", "Core Java concepts, OOP, and data structures", 2400,
                                                2, savedCourse),
                                createLesson("Spring Boot Basics", "Building REST APIs with Spring Boot", 2100, 3,
                                                savedCourse),
                                createLesson("Database Design with MongoDB", "NoSQL database design and integration",
                                                2700, 4,
                                                savedCourse),
                                createLesson("React Fundamentals", "React components, state, and props", 2200, 5,
                                                savedCourse),
                                createLesson("Spring Security", "Authentication and authorization in Spring", 2600, 6,
                                                savedCourse),
                                ...
                                createLesson("Microservices Architecture", "Building microservices with Spring Cloud",
                                                2900, 8,
                                                savedCourse),
                                createLesson("Project Setup", "Setting up the final project structure", 1900, 9,
                                                savedCourse),
                                createLesson("Deployment Strategies", "Deploying full stack applications", 2500, 10,
                                                savedCourse));
        ...
        private void createGitGithubCourse(User instructor, Category category) {
                ...
                List<Lesson> lessons = Arrays.asList(
                                createLesson("Version Control Introduction", "What is version control and why use Git",
                                                1600, 1,
                                                savedCourse),
                                createLesson("Git Installation & Setup", "Installing Git and basic configuration", 1400,
                                                2,
                                                savedCourse),
                                createLesson("Basic Git Commands", "add, commit, push, pull commands", 1800, 3,
                                                savedCourse),
                                createLesson("Branching Strategies", "Creating, merging, and managing branches", 2000,
                                                4, savedCourse),
                                createLesson("GitHub Collaboration", "Working with remote repositories", 1900, 5,
                                                savedCourse),
                                createLesson("Pull Requests & Code Review", "Creating PRs and review process", 1700, 6,
                                                savedCourse),
                                createLesson("Git Workflows", "Different Git workflows for teams", 2100, 7,
                                                savedCourse),
                                createLesson("Advanced Git Features", "Rebase, stash, and cherry-pick", 2200, 8,
                                                savedCourse),
                                createLesson("GitHub Actions CI/CD", "Automating workflows with GitHub Actions", 2400,
                                                9, savedCourse));
                lessonRepository.saveAll(lessons);
        }
        ...
        private void createMernStackCourse(User instructor, Category category) {
                ...
                List<Lesson> lessons = Arrays.asList(
                                createLesson("MERN Stack Overview", "Introduction to MERN stack technologies", 1700, 1,
                                                savedCourse),
                                createLesson("Node.js & Express Setup", "Setting up backend server", 2100, 2,
                                                savedCourse),
                                createLesson("MongoDB Database Design", "NoSQL database design principles", 2300, 3,
                                                savedCourse),
                                createLesson("REST API Development", "Building RESTful APIs with Express", 2500, 4,
                                                savedCourse),
                                createLesson("React Frontend Setup", "Creating React application structure", 1900, 5,
                                                savedCourse),
                                createLesson("State Management", "Managing state with Context API and Redux", 2700, 6,
                                                savedCourse),
                                createLesson("Authentication System", "JWT authentication implementation", 2600, 7,
                                                savedCourse),
                                createLesson("Real-time Features", "WebSocket integration for real-time apps", 2400, 8,
                                                savedCourse),
                                createLesson("Deployment", "Deploying MERN applications", 2200, 9, savedCourse),
                                createLesson("Performance Optimization", "Optimizing MERN stack applications", 2800, 10,
                                                savedCourse));
                lessonRepository.saveAll(lessons);
        }
        ...
        private void createPythonDataScienceCourse(User instructor, Category category) {
                ...
                List<Lesson> lessons = Arrays.asList(
                                createLesson("Python for Data Science", "Python basics for data analysis", 1800, 1,
                                                savedCourse),
                                createLesson("NumPy Fundamentals", "Numerical computing with NumPy", 2000, 2,
                                                savedCourse),
                                createLesson("Pandas Data Analysis", "Data manipulation with Pandas", 2200, 3,
                                                savedCourse),
                                createLesson("Data Visualization", "Creating plots with Matplotlib and Seaborn", 2100,
                                                4, savedCourse),
                                createLesson("Statistical Analysis", "Statistical methods for data science", 2400, 5,
                                                savedCourse),
                                createLesson("Machine Learning Intro", "Introduction to ML algorithms", 2600, 6,
                                                savedCourse),
                                createLesson("Scikit-learn", "Building ML models with scikit-learn", 2500, 7,
                                                savedCourse),
                                createLesson("Data Preprocessing", "Cleaning and preparing data", 2300, 8, savedCourse),
                                createLesson("Project: Data Analysis", "Complete data analysis project", 2800, 9,
                                                savedCourse));
                lessonRepository.saveAll(lessons);
        }
        ...
        private void createReactNativeCourse(User instructor, Category category) {
                ...
                List<Lesson> lessons = Arrays.asList(
                                createLesson("React Native Introduction", "What is React Native and setup", 1600, 1,
                                                savedCourse),
                                createLesson("Components and Styling", "Building UI components", 1900, 2, savedCourse),
                                createLesson("Navigation", "Implementing navigation in mobile apps", 2100, 3,
                                                savedCourse),
                                ...
                                createLesson("Performance Optimization", "Optimizing React Native apps", 2500, 8,
                                                savedCourse));
                lessonRepository.saveAll(lessons);
        }
        ...
        private void createSampleEnrollments() {
                try {
                        if (enrollmentRepository.count() == 0) {
                                ...
                                // 1. Force enroll "komal@lms.com" into specific courses for Testing
                                Optional<User> komalOpt = userRepository.findByEmail("komal@lms.com");
                                if (komalOpt.isPresent()) {
                                        User komal = komalOpt.get();

                                        // Enroll in Java Full Stack (For Quiz)
                                        courseRepository.findByTitle("Java Full Stack Development")
                                                        .ifPresent(course -> {
                                                                enrollmentRepository.save(Enrollment.builder()
                                                                                .student(komal)
                                                                                .course(course)
                                                                                .progress(45.0) // Not completed yet
                                                                                .build());
                                                                System.out.println(
                                                                                "✅ Tests: Enrolled Komal in Java Full Stack (45%)");
                                                        });

                                        // Enroll in React Native (For Certificate) - 100% Completed
                                        courseRepository.findByTitle("React Native Mobile Development")
                                                        .ifPresent(course -> {
                                                                enrollmentRepository.save(Enrollment.builder()
                                                                                .student(komal)
                                                                                .course(course)
                                                                                ...
                                                                                .build());
                                                                System.out.println(
                                                                                "✅ Tests: Enrolled Komal in React Native (100%)");
                                                        });
                                }

                                int enrollmentsCreated = 0;
                                // Create random enrollments for other students
                                for (User student : students) {
                                        if (student.getEmail().equals("komal@lms.com"))
                                                continue; // Skip komal (already done)
                                ...
                                System.out.println(
                                                "✅ " + enrollmentsCreated + " additional sample enrollments created");
        ...
        private void createSampleQuizzes() {
                try {
                        if (quizRepository.count() == 0) {
                                // Add quiz to "Java Full Stack Development"
                                ...
                                if (courseOpt.isPresent()) {
                                        ...
                                        Quiz quiz1 = Quiz.builder()
                                                        ...
                                                        .description("Test your knowledge of Core Java and OOP concepts")
                                                        .course(course)
                                                        .build();
                                        quiz1 = quizRepository.save(quiz1);

                                        List<Question> questions1 = Arrays.asList(
                                                        Question.builder().quiz(quiz1)
                                                                        .text("What is the size of int variable?")
                                                                        .options(Arrays.asList("8 bit", "16 bit",
                                                                                        "32 bit", "64 bit"))
                                                                        .correctOptionIndex(2)
                                                                        .build(),
                                                        Question.builder().quiz(quiz1)
                                                                        .text("Which of these is not a Java feature?")
                                                                        .options(Arrays.asList("Object Oriented",
                                                                                        "Use of pointers", "Portable",
                                                                                        "Dynamic"))
                                                                        .correctOptionIndex(1).build(),
                                                        Question.builder().quiz(quiz1)
                                                                        .text("What is the return type of the hashCode() method in the Object class?")
                                                                        .options(Arrays.asList("int", "Object", "long",
                                                                                        "void"))
                                                                        .correctOptionIndex(0)
                                                                        .build());
                                        questionRepository.saveAll(questions1);
                                        System.out.println("✅ Created Java Quiz");
                                }

                                // Add quiz to "React Native Mobile Development"
                                Optional<Course> courseOpt2 = courseRepository
                                                .findByTitle("React Native Mobile Development");
                                if (courseOpt2.isPresent()) {
                                        Course course = courseOpt2.get();

                                        Quiz quiz2 = Quiz.builder()
                                                        .title("React Native Basics")
                                                        .description("Check your understanding of Components and State")
                                                        .course(course)
                                                        .build();
                                        quiz2 = quizRepository.save(quiz2);

                                        List<Question> questions2 = Arrays.asList(
                                                        Question.builder().quiz(quiz2)
                                                                        .text("What is used to handle state in functional components?")
                                                                        .options(Arrays.asList("setState", "useState",
                                                                                        "this.state", "redux"))
                                                                        .correctOptionIndex(1).build(),
                                                        Question.builder().quiz(quiz2).text(
                                                                        "Which component is used to render a list?")
                                                                        .options(Arrays.asList("FlatList", "ListView",
                                                                                        "ScrollView", "RecyclerView"))
                                                                        .correctOptionIndex(0).build());
                                        questionRepository.saveAll(questions2);
                                        System.out.println("✅ Created React Native Quiz");
                                }

                        } else {
                                System.out.println("ℹ️ Quizzes already exist");
                        }
                } catch (Exception e) {
